...
class DDPG(object):
    ...
    def load(self):
        self.actor.load_state_dict(torch.load(
            '/home/zyf/dobot_ws/models_and_rewards/models/DDPG_actor_random_reform.pth'))
        self.critic.load_state_dict(torch.load(
            '/home/zyf/dobot_ws/models_and_rewards/models/DDPG_critic_random_reform.pth'))
        print("====================================")
...
class arm_control():
    ...
    def go_down(self):
        end_x, end_y, end_z = self.get_eof_location()
        traj = self.get_traj(end_x, end_y, end_z-0.065)
        self.execut(traj)
