...
class DDPG(object):
    ...
    def save(self):
        torch.save(self.actor.state_dict(), '/home/zyf/dobot_ws/models_and_rewards/models/DDPG_actor1.pth')
        torch.save(self.critic.state_dict(), '/home/zyf/dobot_ws/models_and_rewards/models/DDPG_critic1.pth')

    def load(self):
        self.actor.load_state_dict(torch.load('/home/zyf/dobot_ws/models_and_rewards/models/DDPG_actor_random_best.pth'))
        self.critic.load_state_dict(torch.load('/home/zyf/dobot_ws/models_and_rewards/models/DDPG_critic_random_best.pth'))
        print("====================================")
...
def main():
    ...
    for eps in range(max_episode):
        ...
        traj, _, _, _ = dobot.verify_executable()
        dobot.execut(traj)
        ...
        while True:
            ...
            if moved == 1:
                ...
                if len(agent.replay_buffer.storage) > 200:
                    agent.update(eps)
        ...
        workbook.save('/home/zyf/dobot_ws/models_and_rewards/plot_reward/DDPG_rewards_reform.xls')
